      ...
      <div className="mb-3">
        ...
        <div className="relative w-full border-none">
          <select
            ...
            value=""
            name="state"
            className="opacity-50 bg-gray-100 bg-opacity-50 border border-gray-500 text-white appearance-none inline-block py-3 pl-3 pr-8 rounded leading-tight w-full"
          >
