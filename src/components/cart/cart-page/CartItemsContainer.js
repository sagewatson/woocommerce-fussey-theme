      ...
      {cart ? (
        <div className="woo-next-cart-wrapper container">
          <div className="cart-header grid grid-cols-2 gap-4">
            <h1 className="text-2xl mb-5 uppercase text-white">Cart</h1>
            {/*Clear entire cart*/}
            <div className="clear-cart text-right">
              ...
              {clearCartProcessing ? (
                <p className="text-white">Clearing...</p>
              ) : (
                ""
              )}
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-0 xl:gap-4 mb-5">
            <table className="cart-products table-auto col-span-3 mb-5">
              <thead className="text-left">
                <tr className="woo-next-cart-head-container text-white">
                  ...
                  <th
                    className="woo-next-cart-heading-el cart-product-heading"
                    scope="col"
                  >
                    Quantity
                  </th>
        ...
        <div className="container mx-auto my-32 px-4 xl:px-0">
          <h2 className="text-2xl mb-5 text-white">No items in the cart</h2>
          <Link href="/">
